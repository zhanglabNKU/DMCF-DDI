...
from utlis import tc_datasets, get_path_tc, tc_arange_batch, tc_input_mat
import os
from metric import tc_class_auc, tc_class_aupr, tc_mapk_, tc_class_acc
...
def main(args):
    ...
    node_mark = np.load(kg_path['node_mark'], allow_pickle=True).item()
    # ---------------------------- #
    results = {}
    print('Loading....')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default='Task A',
                        help='Task A or B')
